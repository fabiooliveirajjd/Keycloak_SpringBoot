package br.com.fabiooliveira.app_auth.auth;
...
public class TokenController {
    ...
    public ResponseEntity<String> token(@RequestBody User user) {
        ...
        var result = rt.postForEntity("http://localhost:8080/realms/fabio/protocol/openid-connect/token", entity, String.class);
